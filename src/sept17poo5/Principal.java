    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //Mandar a metodo;
         ...
         if(e.getSource()==botonIni){
             double ingresos=0.0;
             ingresos=lapiz.calcularPrecio()+borrador.calcularPrecio()+pan.calcularPrecio()+aspirina.calcularPrecio();
             ing.setText(String.valueOf(ingresos));
             promas.setText(p4.getText());
             promes.setText(p3.getText());
